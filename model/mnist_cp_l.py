...
class CP(chainer.Chain):
    def __init__(self, with_bp=True):
        super(CP, self).__init__(
            #conv1  = LX.Convolution2DCP(  1, 32, 5, with_bp=with_bp),
            conv1s = LX.Convolution2DCP(  1, 32, 3, with_bp=with_bp),
            conv2  = LX.Convolution2DCP( 32,256, 5, with_bp=with_bp, pad=1),
            conv2s = LX.Convolution2DCP( 32,256, 3, with_bp=with_bp),
        )
