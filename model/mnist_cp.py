...
class CP(chainer.Chain):
    def __init__(self, with_bp=True):
        super(CP, self).__init__(
            #conv1  = LX.Convolution2DCP(  1, 16, 5, with_bp=with_bp),
            conv1s = LX.Convolution2DCP(  1, 16, 3, with_bp=with_bp),
            conv2  = LX.Convolution2DCP( 16, 64, 5, with_bp=with_bp, pad=1),
            conv2s = LX.Convolution2DCP( 16, 64, 3, with_bp=with_bp),
        )
