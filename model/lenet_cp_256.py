...
class CP(chainer.Chain):
    def __init__(self, with_bp=True):
        super(CP, self).__init__(
            ...
            #conv2l = LX.Convolution2DCP(128, 256, 7, with_bp=with_bp, pad=2),
            conv2  = LX.Convolution2DCP(128, 256, 5, with_bp=with_bp, pad=1),
            conv2s = LX.Convolution2DCP(128, 256, 3, with_bp=with_bp),
        )
